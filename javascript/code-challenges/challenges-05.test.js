...
const addPurchases = (arr) => {
  ...
  arr.forEach(element => {
    ...
    purchaseFunc.push(element);
  });
  return purchaseFunc.reduce((accumulator, currentValue) =>
    accumulator + currentValue, totalPurchase);
};
...
const reversedString = (str) => {
  let stringOne = str.split('');
  let reverseStr = stringOne.reverse();
  let combineString = reverseStr.join('');
